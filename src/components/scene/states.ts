...
export const STATES: readonly SceneState[] = [
  ...
  { name: "approach", scale: 2.3, x: 0.7, y: -0.02, rx: 0.07, ry: 0.5, rz: 0, stage: "lemon", ink: "ink" },
  { name: "cases", scale: 2.8, x: -0.9, y: 0.02, rx: 0.07, ry: -0.6, rz: 0, stage: "tangerine", ink: "ink" },
  { name: "culture", scale: 3.3, x: 1.1, y: -0.02, rx: 0.06, ry: 0.6, rz: 0, stage: "lyon", ink: "ink" },
  { name: "louder", scale: 3.8, x: -1.3, y: 0.02, rx: 0.07, ry: -0.7, rz: 0, stage: "ink", ink: "lemon" },
