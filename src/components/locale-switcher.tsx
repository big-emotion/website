    ...
    >
      {locales.map((option) => (
        <NextLink
          ...
          className="font-body inline-flex min-h-11 min-w-11 items-center justify-center px-3 text-[15px] font-medium uppercase tracking-[0.08em] hover:opacity-60 aria-[current=true]:opacity-40"
        >
          {option.toUpperCase()}
