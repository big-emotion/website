...
tarteaucitron.services.datingaffiliationpopup = {
  ...
  js: function () {
    ...
    for (i = 0; i < uniqIds.length; i += 1) {
      ...
      uri +=
        "comfrom=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "comfrom") +
        "&";
      uri +=
      ...
      uri +=
        "nicheId=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "nicheid") +
        "&";
      uri +=
        "degreId=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "degreid") +
        "&";
...
tarteaucitron.services.shareasale = {
  ...
  js: function () {
    ...
    for (i = 0; i < uniqIds.length; i += 1) {
      ...
      uri +=
        "persale=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "persale") +
        "&";
      uri +=
        "perlead=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "perlead") +
        "&";
      uri +=
        "perhit=" + tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "perhit") + "&";
      uri +=
        "merchantID=" +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), "merchantID");
      document.getElementById(uniqIds[i]).innerHTML =
        "<img src='" + uri + "' width='1' height='1' />";
    }
  },
...
tarteaucitron.services.xiti = {
  ...
  js: function () {
    ...
    if (parseFloat(navigator.appVersion) >= 4) {
      Xt_s = screen;
      Xt_i +=
        "&r=" + Xt_s.width + "x" + Xt_s.height + "x" + Xt_s.pixelDepth + "x" + Xt_s.colorDepth;
    }
    div.innerHTML =
      Xt_i +
      "&ref=" +
