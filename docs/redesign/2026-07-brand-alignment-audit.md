...
- Rules (PDF p.2, verbatim, FR): *“Le logo est un bloc. On préserve sa zone de protection (= la hauteur du !) et on ne le déforme jamais. Ne pas utiliser d’autres associations de couleurs que celles proposées ici, ne pas étirer ni déformer sauf pour un habillage graphique, ne pas ajouter d’ombre, contour ou effet, ne pas poser un fond qui nuit au contraste.”*
