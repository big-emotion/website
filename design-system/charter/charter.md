...
the tokens actually shipped in `src/app/globals.css`. This file documents *why*
...
display type: uppercase, tight tracking (`-0.02em`), tight leading (`0.92`), weight
400. BBH Hegarty's cmap is **ASCII-only** (DEC-023) — display-slot copy must stay
